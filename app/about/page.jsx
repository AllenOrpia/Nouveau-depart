...
const AboutPage = () => {
  return (
    <main className="container mx-auto p-12 sm:p-8 lg:p-0 flex flex-col items-center justify-center gap-5 h-screen">
      <h1 className="text-5xl font-bold text-center">
      About Nouveau Depart: Embrace New Beginnings Through Shared Stories
      </h1>
